        ...
        <div className='home_page' style={{ overflowY: 'scroll', height: '100vh' }}>
            ...
            <div className='row terms_and_condtions_text'>
                ...
                <div className='col-lg-6 complete_terms'>
                    <div>
                        <h6>Welcome to Quickshorts!</h6>
                        <p>These terms and conditions outline the rules and regulations for the use of Quickshorts's Website, located at quickshorts.app
                            By accessing this website we assume you accept these terms and conditions. Do not continue to use Quickshorts if you do not agree to take all of the terms and conditions stated on this page.
                    ...
                    <div>
                        <h6>Cookies</h6>
                        <p>We employ the use of cookies. By accessing Quickshorts, you agreed to use cookies in agreement with Quickshorts's Privacy Policy.
                            Most interactive websites use cookies to let us retrieve the user’s details for each visit. Cookies are used by our website to enable the functionality of certain areas to make it easier for people visiting our website. Some of our affiliate/advertising partners may also use cookies.
                        </p>
                    </div>
                    <div>
                        <h6>License</h6>
                        <p>Unless otherwise stated, Quickshorts and/or its licensors own the intellectual property rights for all material on Quickshorts. All intellectual property rights are reserved. You may access this from Quickshorts for your personal use subject to restrictions set in these terms and conditions.
                        </p>
                        <p>You must not:</p>
                        <ul>
                            <li>Republish material from Quickshorts</li>
                            <li>Sell, rent, or sub-license material from Quickshorts</li>
                            <li>Redistribute content from Quickshorts</li>
                            <li>Redistribute content from Quickshorts</li>
                        </ul>
                        <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas of the website. Quickshorts does not filter, edit, publish or review Comments before their presence on the website. Comments do not reflect the views and opinions of Quickshorts, its agents, and/or affiliates. Comments reflect the views and opinions of the person who posts their views and opinions. To the extent permitted by applicable laws, Quickshorts shall not be liable for the Comments or any liability, damages, or expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.</p>
                        ...
                        <ul>
                            ...
                            <li>System-wide Accredited Businesses except soliciting non-profit organizations, charity shopping malls, and charity fundraising groups which may not hyperlink to our Website.
                            </li>
                        </ul>
                        ...
                        <p>No use of Quickshort's logo or other artwork will be allowed for linking absent a trademark license agreement.
                            iFrames
                        ...
                        <p>Your Privacy
                        </p><p>Please readPrivacy Policy</p>
                    </div>
                    <div>
